...
public abstract class Figure {
    ...
    public abstract void dragFigure(Point mousePosition, int dx, int dy);
    public boolean IsInsideFigure(Point mousePosition) {
        return (mousePosition.x >= this.x) && (mousePosition.x <= this.x + width) && (mousePosition.y >= this.y) && (mousePosition.y <= this.y + height);
    }
